...
//		để tạo ra thanh menu ta dùng công cụ JMenuBar
		...
		// tạo ra JCheckBoxMenuItem để có thêm thêm vào tick chọn 
		JCheckBoxMenuItem jCheckBoxMenuItem_viewToolBar = new JCheckBoxMenuItem("ToolBar");
		jCheckBoxMenuItem_viewToolBar.addActionListener(ac);
		jMenu_view.add(jCheckBoxMenuItem_viewToolBar);
