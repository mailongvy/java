...
public class test {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("--- 11. Doc du lieu cua danh sach sinh vien xun tu tap tin");
			System.out.println("---------------------------------------------------");
...
//			ghi xuong file
				...
				File f = new File("C:\\Users\\LENOVO\\Desktop\\eclipse-workspace\\File_doc_du_lieu_tu_file\\" + tenfile);
